        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('users.index') }}" class="btn btnprimary btn-sm">&larr; Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="password" class="col-md-4 col-formlabel text-md-end text-start">Password</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <select class="form-select @error('roles') isinvalid @enderror" multiple aria-label="Roles"
                                    id="roles" name="roles[]">

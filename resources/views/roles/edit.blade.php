        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('roles.index') }}" class="btn btnprimary btn-sm">&larr; Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('roles.update', $role->id) }}" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="permissions"
                                class="col-md-4 col-formlabel text-md-end text-start">Permissions</label>
                            <div class="col-md-6">
                                <select class="form-select @error('permissions') is-invalid @enderror" multiple
                                    arialabel="Permissions" id="permissions" name="permissions[]" style="height:210px;">
